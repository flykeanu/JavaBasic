...
//클래스의 모든 필드와 메서드를 물려받을 수 있다
 //기존 클래스를 부모/상위/슈퍼 클래스라고 하고
 //새롭게 작성된 클래스를 자식/하위/서브 클래스라고 한다

 //상속의 장점
 //기존 작성된 클래스를 재활용할 수 있고
 //클래스의 계층적 구조파악이 용이해진다
 //소프트웨서 생산성도 향상되는 장점이 있다
**/
